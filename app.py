...
st.set_page_config(
    page_title='Eco | Clima', layout='wide',
...
def main():
    ...
    with st.container():
        st.title('Eco | Clima')
        st.markdown('#### Visualizador de Datos Climáticos de ECO Consultor')

        st.markdown('Bienvenido a **Eco | Clima**. Carga un archivo EPW de tu sistema para'
                    ' visualizarlo. Por defecto, la aplicación carga el archivo EPW de'
                    ' Boston, EE. UU.')
